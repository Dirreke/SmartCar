...
void Variable_update(void)
{
  ...
  Variable[13] = car_straight_angle* SERVO_RANGE / ANGLE_RANGE;//Allwhitestart * 100 + Allwhiteend;
  Variable[14] = car_center_dias;//100 + Lef_circle * 10 + Rig_circle; /*Rig_circle;*/ //Road6_flag ;//CarSpeed2;
  Variable[15] = Allwhitestart * 100 + Allwhiteend;//EM_Value_2+EM_Value_3; //whitecnt;//Road1_turnout;//limit_pos(EM_Value_1/1.5-EM_Value_2/3.5);//speedTarget1;//map_line[MIN(50,AllWhileStartLine)];
