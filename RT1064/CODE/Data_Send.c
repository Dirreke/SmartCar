...
void Variable_update(void)
{
  ...
  Variable[0] = Turn_Out;//DDDebug;                //EM_Value_4;//crossing_flag_flag;                 //Mid_intercept;//MotorOut1_add;      //Cam_offset;   //EM_Value_1;// Cam_offset;//cntt;//ToF_distance;
  Variable[1] = icm_gyro_y_w;//Turn_Out;               //EM_Value_2; //Turn_Cam_Out;//cnt;//Turn_Cam_Out;//;//stat_slope;//gyroy_1;//Turn_Cam_Out;//Car_W;
  Variable[2] = icm_gyro_y_angle;//PID_CAR_STRAIGHT_CAM.P; //icm_gyro_y_w;//Lef_innercurve_point * 100 + Rig_innercurve_point;//mean_turn_out;//Allwhitestart * 100 + Allwhiteend; //Picture_Failure; //curve_state * 100 + Mid_slope; //Allwhitestart * 100 + Allwhiteend; //EM_Value_1;//Cam_offset;
  ...
  Variable[11] = Mid_slope;
  Variable[12] = MotorOut1;                                  //EM_Value_2;//MotorOut2;         //Turn_EM_Out;  //Lef_break_point*100+Rig_break_point;
  Variable[13] = MotorOut2;//(int)(EM_Value_2 * 100) * 100 + EM_Value_3; //icm_gyro_y_w;      //MotorOut1_add;
  Variable[14] = (int)(EM_Value_2 * 100) * 100 + EM_Value_3;//Mid_slope;                                  //icm_gyro_z_angle;        //icm_gyro_y_angle;  //MotorOut2_add;//speed_change_flag;//car_center_dias;   //100 + Lef_circle * 10 + Rig_circle; /*Rig_circle;*/ //Road6_flag ;//CarSpeed2;
