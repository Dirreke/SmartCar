...
void Variable_update(void)
{
  ...
  //Variable[15]=ToF_distan;//EM_Value_4;//ToF_distance;//MotorOut2;//CarSpeed2;
  // Variable[0] = EM_Value_1;  //Cam_offset;   //EM_Value_1;// Cam_offset;//cntt;//ToF_distance;
  // Variable[1] = EM_Value_2;  //EM_Value_2; //Turn_Cam_Out;//cnt;//Turn_Cam_Out;//;//stat_slope;//gyroy_1;//Turn_Cam_Out;//Car_W;
  // Variable[2] = EM_Value_3; //EM_Value_1;//Cam_offset;
  // Variable[3] = EM_Value_4;
  // Variable[4] = icm_gyro_y_angle; //EM_Value_1; //speedTarget1; //Allwhiteend;
  // Variable[5] = icm_gyro_y; //EM_Value_2; //
  // Variable[6] = icm_gyro_y_w; //EM_Value_3;
  // Variable[7] = CarSpeed1;  //EM_Value_4;

  // Variable[8] = CarSpeed2; //EM_offset;
  // Variable[9] = EM_straight_offset; //speedTarget2;//Turn_Cam_Out;
  // Variable[10] = EM_center_offset;
