...
void Variable_update(void)
{
  ...
  Variable[2] = mean_turn_out;//Allwhitestart * 100 + Allwhiteend; //Picture_Failure; //curve_state * 100 + Mid_slope; //Allwhitestart * 100 + Allwhiteend; //EM_Value_1;//Cam_offset;
  Variable[3] = CarSpeed1;
  Variable[4] = CarSpeed2;                       //EM_Value_1; //speedTarget1; //Allwhiteend;
  Variable[5] = Lef_innercurve_point;//icm_gyro_z_w;//speedTarget1;                    //EM_Value_2;
  Variable[6] = Rig_innercurve_point;//icm_gyro_z_offset;//speedTarget2;                    //speedTarget2; //EM_Value_3;
  ...
  Variable[14] = icm_gyro_z_angle;        //icm_gyro_y_angle;  //MotorOut2_add;//speed_change_flag;//car_center_dias;   //100 + Lef_circle * 10 + Rig_circle; /*Rig_circle;*/ //Road6_flag ;//CarSpeed2;
