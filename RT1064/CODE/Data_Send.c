...
void Variable_update(void)
{
  ...
  Variable[0] =Cam_offset;//Mid_intercept;//MotorOut1_add;      //Cam_offset;   //EM_Value_1;// Cam_offset;//cntt;//ToF_distance;
  ...
  Variable[7] = Cam_offset;//Mid_status;  //EM_Value_1;//Cam_offset;
  if (Road == 0)
  {
  ...
  Variable[14] = Cam_offset;//car_center_dias;                                //100 + Lef_circle * 10 + Rig_circle; /*Rig_circle;*/ //Road6_flag ;//CarSpeed2;
