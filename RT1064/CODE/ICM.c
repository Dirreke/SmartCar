...
{
    static float ICMx_filter[4] = {0, 0, 0, 0}; //offset滤波数组
    ICMx_filter[3] = ICMx_filter[2];
    ICMx_filter[2] = ICMx_filter[1];
    ICMx_filter[1] = ICMx_filter[0];
    ICMx_filter[0] = icm_gyro_x;
    icm_gyro_x = ICMx_filter[0] * 0.5 + ICMx_filter[1] * 0.2 + ICMx_filter[2] * 0.2 + ICMx_filter[3] * 0.1;
}
/*************************************************************************
...
{
    static float ICMy_filter[4] = {0, 0, 0, 0}; //offset滤波数组
    ICMy_filter[3] = ICMy_filter[2];
    ICMy_filter[2] = ICMy_filter[1];
    ICMy_filter[1] = ICMy_filter[0];
    ICMy_filter[0] = icm_gyro_y;
    icm_gyro_y = ICMy_filter[0] * 0.5 + ICMy_filter[1] * 0.2 + ICMy_filter[2] * 0.2 + ICMy_filter[3] * 0.1;
}
/*************************************************************************
...
{
    static float ICMz_filter[4] = {0, 0, 0, 0}; //offset滤波数组
    ICMz_filter[3] = ICMz_filter[2];
    ICMz_filter[2] = ICMz_filter[1];
    ICMz_filter[1] = ICMz_filter[0];
    ICMz_filter[0] = icm_gyro_z;
    icm_gyro_z = ICMz_filter[0] * 0.5 + ICMz_filter[1] * 0.2 + ICMz_filter[2] * 0.2 + ICMz_filter[3] * 0.1;
}